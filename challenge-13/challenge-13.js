(function() {
    ...
    */
    var nordeste = ['MA', 'CE', 'RN', 'PB', 'PE', 'PI', 'AL', 'BA', 'SE'];
    ...
    */
    var newBrasilNew = newBrasil.map(function (item) {
        return {
            id: item.id + 1,
    ...
    */
    ...
    console.log(newBrasilNew);

    /*
    Filtre o array criado acima, retornando somente os estados que tiverem
    ID par. Atribua o valor à uma variável chamada `filter`.
    */
    var filter = newBrasilNew.filter(function (item) {
        return item.id % 2 === 0;
    })
