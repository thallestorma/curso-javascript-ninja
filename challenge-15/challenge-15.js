(function () {
  ...
  */
  ...
  var person1 = new Person('Thalles', 'Torma', 27);
  var person2 = new Person('Lucy', 'Medina', 28);
  var person3 = new Person('Jojô', 'Torma', 0.6);
  ...
  */
  ...
  console.log(person3.getFullName() + ' agora tem ' + person3.addAge(1).getAge() + ' anos.')
})();