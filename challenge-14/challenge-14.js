(function() {
    ...
    */
    ...
    var name = ['Tha', 'lles'];
    var reducedName = name.reduce(function(accumulator, item) {
    ...
    */
    ...
    var hasNumber2Last = numberObjects.lastIndexOf({number: 2}, 2);
    console.log(hasNumber2Last > -1 ? 'Existe um objeto { number: 2 } em numberObjects!' : 'Não existe um objeto { number: 2 } em numberObjects :(');
